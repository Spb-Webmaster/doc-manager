...
<style>
  ...
  /* ── Modals ── */
  /* Smart Invoice modal */
  .si-period-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; margin-bottom: 18px; }
  .si-period-card { border: 1.5px solid var(--border); border-radius: var(--rad-sm); padding: 12px 14px; cursor: pointer; transition: border-color .15s, background .15s; }
  .si-period-card:hover { border-color: var(--accent); background: var(--accent-lt); }
  .si-period-card.active { border-color: var(--accent); background: var(--accent-lt); }
  .si-period-card input { display: none; }
  .si-period-label { font-size: 13.5px; font-weight: 600; color: var(--text-h); }
  .si-period-sub { font-size: 12px; color: var(--text-s); margin-top: 2px; }
  .si-section { margin-bottom: 18px; }
  .si-section-label { font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .5px; color: var(--text-s); margin-bottom: 8px; }
  .si-day-wrap { display: flex; align-items: center; gap: 10px; }
  .si-day-input { width: 80px; height: 40px; border: 1.5px solid var(--border); border-radius: var(--rad-sm); text-align: center; font-size: 16px; font-weight: 600; color: var(--text-h); background: var(--bg); outline: none; transition: border-color .15s; }
  .si-day-input:focus { border-color: var(--accent); }
  .si-day-hint { font-size: 12.5px; color: var(--text-s); }
  .si-toggle { display: flex; gap: 8px; }
  .si-toggle-btn { flex: 1; height: 38px; border: 1.5px solid var(--border); border-radius: var(--rad-sm); background: transparent; cursor: pointer; font-size: 13.5px; font-weight: 600; color: var(--text-s); transition: border-color .15s, background .15s, color .15s; }
  .si-toggle-btn.active { border-color: var(--accent); background: var(--accent-lt); color: var(--accent); }
  .si-note { background: var(--bg); border: 1px solid var(--border); border-radius: var(--rad-sm); padding: 12px 14px; font-size: 12.5px; color: var(--text-s); line-height: 1.5; margin-bottom: 4px; }
  .si-note strong { color: var(--text-h); }
  ...
  /* Bank block */
  .bank-block { width: 100%; border-collapse: collapse; margin-bottom: 16px; font-size: 11px; }
  .bank-block td { border: 1px solid #666; padding: 4px 7px; vertical-align: top; }
  .bb-main { font-size: 11.5px; line-height: 1.5; }
  .bb-sublabel { font-size: 9.5px; color: #555; margin-top: 3px; }
  .bb-key { width: 48px; font-size: 10px; color: #333; white-space: nowrap; border-left: 1px solid #666; }
  .bb-val { font-size: 11px; font-weight: 600; white-space: nowrap; border-left: 1px solid #666; }
  .bb-recip { font-size: 11.5px; line-height: 1.55; }
  ...
  .inv-pk { width: 115px; flex-shrink: 0; color: #222; }
  .inv-pv { flex: 1; }
  ...
  /* Notice */
  .inv-notice { margin-top: 14px; font-size: 10.5px; color: #333; line-height: 1.65; }
  .inv-notice-title { font-weight: 700; }

  /* Signature */
  .inv-sig-area { margin-top: 28px; }
  .inv-sig-row { display: flex; align-items: flex-end; gap: 8px; }
  .inv-sig-role { font-size: 12px; font-weight: 600; white-space: nowrap; }
  .inv-sig-line-el { flex: 1; border-bottom: 1px solid #000; height: 40px; position: relative; }
  .inv-stamp { margin-top: 8px; display: flex; justify-content: center; }
  .inv-stamp-circle {
